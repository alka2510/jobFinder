...
class Home extends React.Component {
  ...
  render() {
    return (
      <div className="ui container home" style={{ alignItems: "center" }}>
        <div>
          <div
            className="row"
            style={{ padding: "15px", marginTop: "20px", marginBottom: "40px" }}
          >
            <div className="col">
        ...
        <div className="row">
          <div
            className="col"
            style={{ maxWidth: "1000px", paddingLeft: "50px" }}
          >
            {this.state.isName &&
            (this.state.term || this.state.jobLocation) ? (
